...
fun feast(beast: String, dish: String): Boolean = (beast[0] == dish[0]) && (beast[beast.length-1] == dish[dish.length-1])


fun main() {
    println(feast("eagle", "egg trifle"))
    println(feast("turtle", "tiramisu elite"))
    println(feast("mamba", "apple pie"))
}